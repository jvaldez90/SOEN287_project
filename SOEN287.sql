...
--
-- Host: localhost
-- Generation Time: Dec 05, 2022 at 07:29 PM
...
CREATE TABLE `grade_records` (
  ...
  `assignment_3` float DEFAULT NULL,
...
INSERT INTO `grade_records` (`id`, `name`, `assignment_1`, `assignment_2`, `assignment_3`, `midterm`, `final_exam`, `average`, `final_grade`) VALUES
(1, 'Barry Allen', 75, 80, 63, 67, 73, NULL, NULL),
(2, 'Oliver Queen', 65, 74, 82, 63, 87, NULL, NULL),
(3, 'Kara Danvers', 62, 73, 88, 92, 78, NULL, NULL),
(4, 'Jefferson Pierce', 65, 88, 95, 73, 61, NULL, NULL),
...
(11, 'Clark Kent', 51, 52, 53, 54, 55, NULL, NULL);
